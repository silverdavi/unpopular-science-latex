...
{
\section*{Topology and Trigonometry in Number Theory}  
We present two distinct proofs of the infinitude of primes: one using topology and another via a trigonometric product identity.
